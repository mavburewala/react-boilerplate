...
module.exports = {
  ...
  module: {
    loaders: [
      ...
      { test: /\.css/, loader: ExtractTextPlugin.extract('style', 'css?modules&importLoaders=2&sourceMap!postcss-loader?outputStyle=expanded&sourceMap=true&sourceMapContents=true') },
